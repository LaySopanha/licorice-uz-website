...
const FloatingContact = () => {
    ...
    const whatsapp = settings?.whatsapp || CONTACT_INFO.social.whatsapp;
    const telegram = settings?.telegram || CONTACT_INFO.social.telegram;
    ...
    const tgLink = `https://t.me/${telegram}?text=${encoded}`;
